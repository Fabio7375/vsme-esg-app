...
st.title("🟢 Compilazione semplificata - Bilancio di Sostenibilità VSME") st.markdown(""" Compila i campi sottostanti per generare automaticamente un report ESG semplificato, adatto per micro e piccole imprese secondo il modello VSME (EFRAG). """)
