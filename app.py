...
# 2. Strategia ESG
tab2 = st.expander("2. Strategia e Governance ESG")
with tab2:
...
# 3. Ambiente
ambiente = st.expander("3. Ambiente")
with ambiente:
    ...
    emissioni = st.number_input("Emissioni gas serra (Scope 1 e 2, tCO₂eq)", min_value=0.0)
...
# 5. Governance
governance_section = st.expander("5. Governance")
with governance_section:
...
if st.button("📥 Esporta Report in Excel"):
    data = {
        ...
        "Strategia ESG": [strategia], "Rischi ESG": [rischi], "Obiettivi ESG": [obiettivi],
        "Governance ESG": [governance], "Coinvolgimento Stakeholder": [stakeholder],
        "Energia kWh": [energia], "Energia Rinnovabile %": [energia_rinnovabile],
        "Emissioni tCO2eq": [emissioni], "Consumo Idrico": [acqua], "Rifiuti kg": [rifiuti],
        "Riciclo %": [riciclo], "% Donne": [donne], "% Donne Mgmt": [donne_mgmt],
        "Formazione Ore": [formazione], "Infortuni": [infortuni], "Turnover %": [turnover],
